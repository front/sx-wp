...
if ( ! function_exists( 'starterx_setup' ) ) :
/**
 ...
 */
function starterx_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Under Timber, use a find and replace
	 * to change 'fk-starterx' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'fk-starterx', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'top' => esc_html__( 'Top Menu', 'fk-starterx' ),
		'main' => esc_html__( 'Main Menu', 'fk-starterx' ),
//		'full' => esc_html__( 'Expandable Menu', 'fk-starterx' ),
//        'social' => esc_html__( 'Social Menu', 'fk-starterx' ),
        'mobile' => esc_html__( 'Additional Mobile Menu', 'fk-starterx' ),
	) );
...
add_action( 'after_setup_theme', 'starterx_setup' );
 ...
 */
function starterx_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'starterx_content_width', 640 );
}
add_action( 'after_setup_theme', 'starterx_content_width', 0 );
 ...
 */
function starterx_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'fk-starterx' ),
		'id'            => 'sidebar-1',
		'description'   => '',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer 1', 'fk-starterx' ),
        'id'            => 'footer-1',
        'description'   => __( 'Widgets in this area will be shown on all posts and pages.', 'fk-starterx' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'starterx_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function starterx_scripts() {
	wp_enqueue_style( 'starterx-style', get_stylesheet_uri() );

	wp_enqueue_script( 'starterx-scripts', get_template_directory_uri() . '/build/js/main.js', array('jquery'), '20190121', true );
